...
INSERT INTO `entrenador` VALUES (1,'Carlo','Ancelotti','Italiano',1),(2,'Hansi','Flick','AlemÃ¡n',2),(3,'Diego','Simeone','Argentino',3),(4,'Pep','Guardiola','EspaÃ±ol',4),(5,'Arne','Slot','NeerlandÃ©s',5),(6,'Mikel','Arteta','EspaÃ±ol',6),(7,'Alvaro','Arbeloa','EspaÃ±ol',NULL);
...
INSERT INTO `equipo` VALUES (3,'AtlÃ©tico de Madrid',1),(2,'FC Barcelona',1),(1,'Real Madrid',1),(6,'Arsenal FC',2),(5,'Liverpool FC',2),(4,'Manchester City',2);
...
INSERT INTO `jugador` VALUES (1,'Thibaut','Courtois','Belga',1),(2,'Dani','Carvajal','EspaÃ±ol',1),(3,'Antonio','RÃ¼diger','AlemÃ¡n',1),(4,'Ã‰der','MilitÃ£o','BrasileÃ±o',1),(5,'Ferland','Mendy','FrancÃ©s',1),(6,'Federico','Valverde','Uruguayo',1),(7,'Jude','Bellingham','InglÃ©s',1),(8,'Eduardo','Camavinga','FrancÃ©s',1),(9,'VinÃ­cius','Junior','BrasileÃ±o',1),(10,'Kylian','MbappÃ©','FrancÃ©s',1),(11,'Marc-AndrÃ©','ter Stegen','AlemÃ¡n',2),(12,'Jules','KoundÃ©','FrancÃ©s',2),(13,'Pau','CubarsÃ­','EspaÃ±ol',2),(14,'Alejandro','Balde','EspaÃ±ol',2),(15,'Pedri','GonzÃ¡lez','EspaÃ±ol',2),(16,'Gavi','PÃ¡ez','EspaÃ±ol',2),(17,'Frenkie','de Jong','NeerlandÃ©s',2),(18,'Lamine','Yamal','EspaÃ±ol',2),(19,'Robert','Lewandowski','Polaco',2),(20,'Raphinha','Dias','BrasileÃ±o',2),(21,'Jan','Oblak','Esloveno',3),(22,'Nahuel','Molina','Argentino',3),(23,'Robin','Le Normand','EspaÃ±ol',3),(24,'JosÃ© MarÃ­a','GimÃ©nez','Uruguayo',3),(25,'Reinildo','Mandava','MozambiqueÃ±o',3),(26,'Koke','ResurrecciÃ³n','EspaÃ±ol',3),(27,'Rodrigo','De Paul','Argentino',3),(28,'Marcos','Llorente','EspaÃ±ol',3),(29,'Antoine','Griezmann','FrancÃ©s',3),(30,'JuliÃ¡n','Ãlvarez','Argentino',3),(31,'Ederson','Moraes','BrasileÃ±o',4),(32,'Kyle','Walker','InglÃ©s',4),(33,'Ruben','Dias','PortuguÃ©s',4),(34,'John','Stones','InglÃ©s',4),(35,'Rodri','HernÃ¡ndez','EspaÃ±ol',4),(36,'Kevin','De Bruyne','Belga',4),(37,'Bernardo','Silva','PortuguÃ©s',4),(38,'Phil','Foden','InglÃ©s',4),(39,'Jack','Grealish','InglÃ©s',4),(40,'Erling','Haaland','Noruego',4),(41,'Alisson','Becker','BrasileÃ±o',5),(42,'Trent','Alexander-Arnold','InglÃ©s',5),(43,'Virgil','van Dijk','NeerlandÃ©s',5),(44,'Ibrahima','KonatÃ©','FrancÃ©s',5),(45,'Andrew','Robertson','EscocÃ©s',5),(46,'Alexis','Mac Allister','Argentino',5),(47,'Dominik','Szoboszlai','HÃºngaro',5),(48,'Luis','DÃ­az','Colombiano',5),(49,'Mohamed','Salah','Egipcio',5),(50,'Darwin','NÃºÃ±ez','Uruguayo',5),(51,'David','Raya','EspaÃ±ol',6),(52,'Ben','White','InglÃ©s',6),(53,'William','Saliba','FrancÃ©s',6),(54,'Gabriel','MagalhÃ£es','BrasileÃ±o',6),(55,'Declan','Rice','InglÃ©s',6),(56,'Martin','Ã˜degaard','Noruego',6),(57,'Mikel','Merino','EspaÃ±ol',6),(58,'Bukayo','Saka','InglÃ©s',6),(59,'Gabriel','Martinelli','BrasileÃ±o',6),(60,'Kai','Havertz','AlemÃ¡n',6);
...
INSERT INTO `liga` VALUES (1,'LaLiga','EspaÃ±a',3,20),(2,'Premier League','Inglaterra',3,20);
...
--
-- Table structure for table `webappserverprops`
--
...
CREATE TABLE `webappserverprops` (
  ...
  KEY `WebAppServerProps002` (`ExpiresDate`,`ExpiresTime`,`Key`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
